...
**Portfolio** is a website developed using Bootstrap to showcase web development skills using CSS frameworks such as Bootstrap.
...
```sh
  cd my-folder
  git clone https://github.com/egichuhis/edwin-noel-bootstrap.git
```
...
- [ ] **Add Javascript to make website dynamic**
- [ ] **Link to live demo, Deployment**
